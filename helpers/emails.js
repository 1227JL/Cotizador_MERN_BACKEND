...
export const emailRegistro = async (datos) => {
    ...
    const info = await transport.sendMail({
        from : '"Tienda - Administrador de Proyectos" <cuentas@Tienda.com>',
        to : email,
        subject : "Tienda - Comprueba tu cuenta",
        text: "Comprueba tu cuenta en Tienda",
        html: `<p>Hola ${nombre} Comprueba tu cuenta en Tienda</p>
...
export const emailOlvidePassword = async (datos) => {
    ...
    const info = await transport.sendMail({
        from : '"Tienda - Administrador de Proyectos" <cuentas@Tienda.com>',
        to : email,
        subject : "Tienda - Restablece tu Password",
        text: "Restablece tu Password en Tienda",
